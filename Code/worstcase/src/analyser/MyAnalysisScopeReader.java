...
public class MyAnalysisScopeReader extends AnalysisScopeReader {
	...
	/*public static AnalysisScope makeJavaBinaryAnalysisScope(String classPath, String scjJar) throws IOException {
	    return makeJavaBinaryAnalysisScope(classPath, scjJar);
	  }*/

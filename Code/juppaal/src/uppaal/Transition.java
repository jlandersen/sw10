...
public class Transition {
	...
	public Transition(Automaton automaton, Element transitionElement) {
		...
		source = automaton.id_locationMap.get(automaton.getName().getName() + matcher.group(1));
		...
		destination = automaton.id_locationMap.get(automaton.getName().getName() + matcher.group(1));
